...
--
-- Cấu trúc bảng cho bảng `giatri_thuoctinh`
--

CREATE TABLE `giatri_thuoctinh` (
  `value_id` int(11) NOT NULL,
  `value_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `att_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `giatri_thuoctinh`
--
...
INSERT INTO `tax` (`tax_id`, `tax_type`, `tax_percent`) VALUES
(1, 'VAT', 10),
(2, 'Đặc biệt', 5);
...
(5, 'sangcao1003@gmail.com', 'admin123', 1),
(6, 'pvt@gmail.com', 'admin123', 2);
...
INSERT INTO `thuoctinh` (`att_id`, `att_name`) VALUES
(1, 'Màu sắc'),
(3, 'Dung lượng');
...
--
-- Chỉ mục cho bảng `giatri_thuoctinh`
--
...
--
ALTER TABLE `giatri_thuoctinh`
  ADD CONSTRAINT `giatri_thuoctinh_ibfk_1` FOREIGN KEY (`att_id`) REFERENCES `thuoctinh` (`att_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
